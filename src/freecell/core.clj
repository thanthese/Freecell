...
(def help-msg
  (str "This is Freecell, the best solitaire evar!
  ...
  - " disp/foundation-mobility-symbol " :  card could move to foundation
  - " disp/duplicate-symbol " :  multiple cards of same rank and color in cascade
